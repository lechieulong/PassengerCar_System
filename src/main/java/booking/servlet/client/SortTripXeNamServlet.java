...
@WebServlet(name = "sortTripXeNam",value = "/sortTripXeNam")

public class SortTripXeNamServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<TripsTransportByPointAndDate> tripsTransportFromServerWithCondition = tripsTransportByPointAndDateService.sortLIECar(Long.parseLong(dropOffPoint),Long.parseLong(pickUpPoint),date);
