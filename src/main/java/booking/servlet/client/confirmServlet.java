...
@WebServlet(name = "confirm",value = "/confirmServlet")
public class confirmServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Optional<TripsTransportWithRoutes> tripsTransportWithRoutesFromServer = Protector.of(() ->tripsTransportWithRoutesService.getById(Long.parseLong(tripsTransportId))).get(Optional::empty);
        Optional<SeatTransport> seatTransportFromServer =Protector.of(() ->seatTransportService.getQuantityAndPriceByTrips(Long.parseLong(tripsTransportId))).get(Optional::empty);
        if (tripsTransportWithRoutesFromServer.isPresent() && seatTransportFromServer.isPresent()){
            req.setAttribute("trips",tripsTransportWithRoutesFromServer.get());
            req.setAttribute("seatTransport",seatTransportFromServer.get());
