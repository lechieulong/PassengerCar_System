...
@WebServlet(name = "sortLateTime",value = "/sortLateTime")

public class SortLateTimeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<TripsTransportByPointAndDate> tripsTransportFromServerWithCondition = tripsTransportByPointAndDateService.sortLateTime(Long.parseLong(dropOffPoint),Long.parseLong(pickUpPoint),date);
