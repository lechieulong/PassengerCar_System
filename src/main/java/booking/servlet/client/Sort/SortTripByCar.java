...
@WebServlet(name = "sortTripByCar",value = "/sortTripByCar")

public class SortTripByCar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<TripsTransportByPointAndDate> tripsTransportFromServerWithCondition = tripsTransportByPointAndDateService.sortTripByCar(Long.parseLong(dropOffPoint),Long.parseLong(pickUpPoint),date);
