...
@WebServlet(name = "sortCheapPrice",value = "/sortCheapPrice")

public class SortCheapPriceServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<TripsTransportByPointAndDate> tripsTransportFromServerWithCondition = tripsTransportByPointAndDateService.sortCheapPrice(Long.parseLong(dropOffPoint),Long.parseLong(pickUpPoint),date);
