...
@WebServlet(name = "sortEarlyTime",value = "/sortEarlyTime")

public class SortEarlyTimeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<TripsTransportByPointAndDate> tripsTransportFromServerWithCondition = tripsTransportByPointAndDateService.sortEarlyTime(Long.parseLong(dropOffPoint),Long.parseLong(pickUpPoint),date);
