...
@WebServlet(name = "sortTripXeNgoi",value = "/sortTripXeNgoi")
public class SortTripXeNgoiServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<TripsTransportByPointAndDate> tripsTransportFromServerWithCondition = tripsTransportByPointAndDateService.sortSITCar(Long.parseLong(dropOffPoint),Long.parseLong(pickUpPoint),date);
        ...
        for(TripsTransportByPointAndDate trip : tripsTransportFromServerWithCondition){
            ...
            if(dateConvert.isEqual(datePresent) || dateConvert.isAfter(datePresent) && trip.getName().equals("SIT")){
