            ...
            <div class="row align-items-center">
                <div class="col py-3">
                    <a class="text-body" href="${pageContext.request.contextPath}/admin">
                        <h3><span class="badge bg-primary">Admin</span> Shop </h3>
                    </a>
                </div> <!-- col.// -->
                <div class="col-sm-1">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link ${fn:startsWith(servletPath, '/admin/transportManager') ? 'active' : ''}"
                       href="${pageContext.request.contextPath}/admin/transportManager">
                        <i class="bi bi-tags"></i> Quản lý Phương tiện
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${fn:startsWith(servletPath, '/admin/routeManager') ? 'active' : ''}"
                       href="${pageContext.request.contextPath}/admin/routeManager">
                        <i class="bi bi-book"></i> Quản lý tuyến đường
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${fn:startsWith(servletPath, '/admin/tripsManager') ? 'active' : ''}"
                       href="${pageContext.request.contextPath}/admin/tripsManager">
                        <i class="bi bi-star"></i> Quản lý Chuyến xe
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${fn:startsWith(servletPath, '/admin/ticketManager') ? 'active' : ''}"
                       href="${pageContext.request.contextPath}/admin/ticketManager">
                        <i class="bi bi-inboxes"></i> Đặt vé
                    </a>
                </li>
            </ul>
            <c:choose>
