...
<section class="section-content" style="margin: 100px 0;">
            ...
            <form action="${pageContext.request.contextPath}/signup" method="post">
                ...
                <div class="mb-3">
                   ...
                   ? 'is-invalid' : (not empty requestScope.values.password ? 'is-valid' : '')}"
                           ...
                           title="Ít nhất 6 ký tự, bao gồm ít nhất một số và một chữ cái"
    ...
    <p class="text-center mt-4">Đã có tài khoản? <a href="${pageContext.request.contextPath}/client/signin">Đăng nhập</a></p>
